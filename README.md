...
scr4tchsploitz is a tool to allow the player to modify the game, including but not limited to bypassing anticheat, gaining infinite health, money, teleportation, etc.

using scr4tchsploitz is as simple as downloading the .sprite3 file and importing it into any project of your choice.
